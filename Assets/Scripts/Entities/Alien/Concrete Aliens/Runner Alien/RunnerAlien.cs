...
/*
 *  Controller script for the runner Alien
 *  Attach this script to the enemy model
 */
[RequireComponent(typeof(NavMeshAgent))]
public class RunnerAlien : MonoBehaviour, Alien, Entity
{
    [Header("Stats")]
    ...
    private void Start()
    {
        ...
        // stateMachine.AddState(new StateRunnerAlienPatrol(this, m_playerInfo));
        stateMachine.AddState(new StateRunnerAlienChase(this, m_playerInfo));
        stateMachine.AddState(new StateRunnerAlienAttack(this, m_playerInfo));
        stateMachine.ChangeState("RunnerAlienChase");
    }
    ...
    private void OnDrawGizmos()
    {
        ...
        if (stateMachine.GetCurrentState() == "RunnerAlienPatrol")
        {
            Gizmos.color = Color.green;
        }
        else if (stateMachine.GetCurrentState() == "RunnerAlienChase")
        {
            Gizmos.color = Color.yellow;
        }
        else if (stateMachine.GetCurrentState() == "RunnerAlienAttack")
        {
